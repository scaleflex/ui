  ...
  ({ color = 'currentColor', size = 14, ...rest }, ref): JSX.Element => (
    ...
    >
      <path
        ...
        fill={color}
      />
      <path d="M5 7.5C5 6 6 5 7.5 5C9 5 10 6 10 7.5C10 9 9 10 7.5 10C6 10 5 9 5 7.5Z" fill={color} />
      <path
        ...
        fill={color}
      />
      <path d="M42.5 5C44 5 45 6 45 7.5C45 9 44 10 42.5 10C41 10 40 8.75 40 7.5C40 6 41 5 42.5 5Z" fill={color} />
      <path
        d="M42.5 45C41 45 40 44 40 42.5C40 41.25 41 40 42.5 40C44 40 45 41 45 42.5C45 44 44 45 42.5 45Z"
        fill={color}
      />
      <path d="M7.5 45C6 45 5 44 5 42.5C5 41 6 40 7.5 40C9 40 10 41.25 10 42.5C10 44 9 45 7.5 45Z" fill={color} />
    </svg>
  )
);
