...
export const NoAction = intrinsicComponent<IconProps, SVGSVGElement>(
  ({ color = 'currentColor', size = 14, ...rest }, ref): JSX.Element => (
    ...
    >
      <path
        d="M69.2894 0L53.3999 31.779H69.5865L61.5167 59.0147L63.3465 60L96.5721 20.1277H76.2723L91.114 0H69.2894Z"
        fill={color}
      />
      <path
