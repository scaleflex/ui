...
export const Documentation = ({ color = 'currentColor', size = 14, ref, ...rest }: IconProps): JSX.Element => (
  <svg
    ref={ref}
    width={size}
    height={size}
    ...
    {...rest}
  >
    <path d="M28.5714 8.92857H36.2374L28.5714 1.26256V8.92857Z" fill={color} />
    <path
