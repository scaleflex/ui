...
export const OrientationSquare = intrinsicComponent<IconProps, SVGSVGElement>((
  ...
  >
    ...
    <path fillRule="evenodd" clipRule="evenodd" d="M0.275391 4C0.275391 1.79086 2.06625 0 4.27539 0H46.2754C48.4845 0 50.2754 1.79086 50.2754 4V46C50.2754 48.2091 48.4845 50 46.2754 50H4.27539C2.06625 50 0.275391 48.2091 0.275391 46V4ZM4.27539 2H46.2754C47.38 2 48.2754 2.89543 48.2754 4V46C48.2754 47.1046 47.38 48 46.2754 48H4.27539C3.17082 48 2.27539 47.1046 2.27539 46V4C2.27539 2.89543 3.17082 2 4.27539 2Z" fill={color} />
  </svg>
));
