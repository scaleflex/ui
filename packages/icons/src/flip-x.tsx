...
export const FlipX = intrinsicComponent<IconProps, SVGSVGElement>(
  ({ color = 'currentColor', size = 14, ...rest }, ref): JSX.Element => (
    ...
    >
      ...
      <path
        ...
        fill={color}
      />
      <path d="M35.1066 12.0999L32.6066 7.72486L29.8934 9.2753L32.3934 13.6503L35.1066 12.0999Z" fill={color} />
      <path d="M25.9375 8.50008V12.8751H29.0625V8.50008H25.9375Z" fill={color} />
      <path d="M40.1066 23.9749L37.6066 19.5999L34.8934 21.1503L37.3934 25.5253L40.1066 23.9749Z" fill={color} />
      <path d="M25.9375 20.3751V24.7501H29.0625V20.3751H25.9375Z" fill={color} />
      <path d="M45.1066 32.7249L42.6066 28.3499L39.8934 29.9003L42.3934 34.2753L45.1066 32.7249Z" fill={color} />
      <path d="M25.9375 29.1251V33.5001H29.0625V29.1251H25.9375Z" fill={color} />
      <path
      ...
      <path
        ...
        fill={color}
      />
      <path d="M35 41.6251H40V38.5001H35V41.6251Z" fill={color} />
    </svg>
  )
);
