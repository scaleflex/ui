...
- [theme.breakpoints.getBreakpointClass(width)](#themebreakpointsgetbreakpointclasswidth--breakpoint-class)
...
### `theme.breakpoints.getBreakpointClass(width) => breakpoint class`
...
const styles = styled.div(
   ({theme}) => `
      ...
      // Match [md, ∞)
      //       [1201px, ∞)
      ${theme.breakpoints.getBreakpointClass(1201)} & {
