...
const meta: Meta<typeof DatePicker> = {
  ...
  argTypes: {
    ...
    InputProps: {
      description:
        'The props of the input component. Please refer to the [Input]((ui/?path=/docs/inputs-input--docs#api) component for more information.',
    },
    inputGroupProps: {
      description:
    ...
    popperOptions: {
      description:
        'PopperOptions prop in the popper component. Please refer to the [Popper]((ui/?path=/docs/datadisplay-popper--docs#api) component for more information.',
    },
    zIndex: {
