...
import getViewportRect from './get-viewport-rect';
import getDocumentRect from './get-document-rect';
import listScrollParents from './list-scroll-parents';
import getOffsetParent from './get-offset-parent';
import getDocumentElement from './get-document-element';
import getComputedStyle from './get-computed-style';
import { isElement, isHTMLElement } from './instance-of';
import getBoundingClientRect from './get-bounding-client-rect';
import getParentNode from './get-parent-node';
import contains from './contains';
import getNodeName from './get-node-name';
import rectToClientRect from '../utils/rect-to-client-rect';
...
function getClippingParents(element: Element): Array<Element> {
  ...
  return clippingParents.filter(
    (clippingParent) => isElement(clippingParent)
