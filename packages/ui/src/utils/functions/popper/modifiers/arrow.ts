...
import mergePaddingObject from '../utils/merge-padding-object';
import expandToHashMap from '../utils/expand-to-has-map';
import {
  left, right, basePlacements, top, bottom
} from '../enums';
import { isHTMLElement } from '../dom-utils/instance-of';
