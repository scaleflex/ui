...
export const groupedPalette = {
  ...
  background: {
    ...
    [Color.BackgroundPrimaryLight]: 'rgba(243, 245, 247, 1)', // Not used #F3F5F7
...
export const lightPalette = {
  ...groupedPalette.text,
  ...groupedPalette.accent,
  ...groupedPalette.background,
  ...groupedPalette.icons,
  ...groupedPalette.button,
  ...groupedPalette.link,
  ...groupedPalette.borders,
  ...groupedPalette.states,
  ...groupedPalette.flat,
  ...groupedPalette.uploader,
  ...groupedPalette.extra,
